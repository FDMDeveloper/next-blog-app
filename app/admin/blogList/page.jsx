...
function ManageBlogs() { // Capitalize the function name

  const [blogs, setBlogs] = useState([]); // State variable for blog data
...
export default ManageBlogs; // Export the component
