  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        toast.error(response.data.error || 'Error'); // Handle specific error message
      }
    } catch (error) {
  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8'>
        ...
        <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Rimani aggiornato sulle ultime tendenze e approfondimenti nel mio blog.</p>
        <p>Iscriviti alla nostra newsletter per ricevere i nostri ultimi post direttamente nella tua casella di posta.</p>
